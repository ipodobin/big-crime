...
aws s3api create-bucket --bucket $AWS_ACCOUNT_ID-landing-zone --region $AWS_REGION
aws s3api create-bucket --bucket $AWS_ACCOUNT_ID-formatted-data --region $AWS_REGION
aws s3api create-bucket --bucket 780087431924-query-result --region us-east-1
aws s3api create-bucket --bucket 780087431924-flink --region us-east-1
